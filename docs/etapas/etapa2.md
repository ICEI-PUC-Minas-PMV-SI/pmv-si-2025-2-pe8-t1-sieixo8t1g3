...
#### 2 Informações Processuais e Contratuais
...
<p align="justify">
O KIT selecionado traduz a dor central da cliente, que é a falta de uma ferramenta eficiente para gerenciar e comunicar o andamento dos processos aos seus clientes de forma estruturada.</p>

<p align="justify">
As KIQs foram formuladas com o objetivo de mapear as informações mínimas necessárias para alimentar um sistema que forneça visibilidade processual, segurança de dados e melhoria no relacionamento com o cliente, aspectos essenciais para um escritório que deseja crescer com profissionalismo e confiança.</p>

## 2.3. Mapeamento de Dados e Identificação das Necessidades de Informação

<p align="justify">
No cenário digital, os dados assumem papel estratégico, mas seu valor depende da capacidade de convertê-los em informações úteis para a gestão. Nesta fase inicial, o mapeamento busca identificar e organizar os dados por meio de perguntas-chave de informação (KIQs – Key Information Questions), alinhando-os às necessidades do escritório. Ressalta-se que esta estrutura é preliminar e poderá ser ajustada conforme a evolução do projeto, servindo como base para a construção do sistema e para futuras análises estratégicas.</p>

<p align="center">
<strong>Cadastro e Perfil do Cliente</strong>
</p>

| KIQ | Dados necessários | Classificação | Fonte de dados atual |
|---|---|---|---|
| Quais dados são essenciais para o cadastro completo e padronizado dos clientes? | - Nome<br>- CPF (pessoa física) ou CNPJ (pessoa jurídica)<br>- Endereço<br>- Telefone<br>- E-mail<br>- Estado civil<br>- Nacionalidade | Operacional | Documentos físicos e registros manuais |
| É necessário categorizar os clientes por perfil (tipo de demanda etc.)? | - Indenizações, responsabilidade civil, despejos, ações de cobrança<br>- divórcios, pensão alimentícia, inventários. | Operacional | Documentos físicos e registros manuais |

<p align="center">
<strong>Informações Processuais e Contratuais</strong>
</p>

| KIQ | Dados necessários | Classificação | Fonte de dados atual |
|---|---|---|---|
| Quais informações do processo precisam ser registradas para garantir o acompanhamento em tempo real? | -Petição inicial<br>-Contestação<br>-Impugnação<br>-Memoriais<br>-Sentença<br>-Apelação | Operacional | Documentos físicos e registros manuais |
| Quais são os tipos mais frequentes de contratos e processos atendidos pelo escritório? | **Cíveis:** indenizações, responsabilidade civil, despejos, ações de cobrança, contratos.<br><br>**Família e Sucessões:** divórcios, pensão alimentícia, inventários, guarda e visitas. | Operacional | Documentos físicos e registros manuais |
| Como identificar o status e a fase atual de cada processo de forma automatizada? | - Conhecimento<br>- Execução<br>- Recursos<br>- Em andamento<br>- Em fase de instrução<br>- Em julgamento<br>- Concluído / arquivado | Operacional | Documentos físicos e registros manuais |
| É relevante registrar em qual instância e tribunal o processo tramita? | - juízo (vara)<br>- 1ª instância<br>- 2ª instância<br>- TST<br>- STM<br>- STE<br>- STJ<br>- STF | Operacional | Documentos físicos e registros manuais |
| Onde os prazos processuais são consultados atualmente e como podem ser integrados ao sistema? | - Agenda<br>- PJe<br>- Eproc | Operacional | Documentos físicos, registros manuais e sites |

<p align="center">
<strong>Aspectos Financeiros e Honorários</strong>
</p>

| KIQ | Dados necessários | Classificação | Fonte de dados atual |
|---|---|---|---|
| Os valores dos honorários variam conforme o tipo de cliente ou causa? | - Honorários | Quantitativo | Documentos físicos e registros manuais |
| Existem despesas adicionais ou valores de sucumbência a receber? | - Custas Processuais<br>- Sucumbência<br>- Outros | Quantitativo | Documentos físicos e registros manuais |
| Como são feitos os pagamentos e como o sistema pode registrar esses fluxos? | - À vista<br>- Parcelado (cartão)<br>- Percentual sobre o ganho da causa<br>- Comprovante de pagamento | Operacional | Documentos físicos e registros manuais |
...
| Requisito Informacional | Funcionalidade Relacionada | KIQs Associadas | Informações que o sistema precisa gerar | KPIs Associados |
|---|---|---|---|---|
